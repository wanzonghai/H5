...
module.exports = async (context) =>{
    ...
    var findUserData = await cloud.db.collection("users").aggregate([
        {
            $match: {
                state: true,
                "rankRewardConfig.drawTime": "month"
            }
        },{
            $project: {
                openid: 1,
    ...
    // var sTime = eTime - (30 * 24 * 3600 * 1000);
    var sTime = Number(moment(eTime).subtract(1,"months").format("x").valueOf());
