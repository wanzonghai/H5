...
export default class uiMyGiftButton extends fgui.GButton {

	public m_bubbleBG:fgui.GImage;
	public m_bagNText:fgui.GTextField;
	public static URL:string = "ui://txopsw7as0olf";

	public static createInstance():uiMyGiftButton {
		return <uiMyGiftButton>(fgui.UIPackage.createObject("gift", "MyGiftButton"));
	}
