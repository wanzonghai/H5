...
function genCode(handler: FairyEditor.PublishHandler) {
    ...
    console.log('classes', settings.ignoreNoname,ns,classes);
    ...
    console.log('exportCodePath', getMemberByName);
    ...
    for (let i: number = 0; i < classCnt; i++) {
        ...
        console.log('className',classInfo.className, classInfo.superClassName);
